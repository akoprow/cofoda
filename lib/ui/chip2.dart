...
class Chip2 extends Chip {
  ...
  @override
  Widget build(BuildContext context) => RawChip2(
      label: label,
...
class _RawChipState extends State<RawChip2>
    with TickerProviderStateMixin<RawChip2> {
      ...
      child: InkWell(
        ...
        child: AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget child) {
            return Container(
              decoration:
              ShapeDecoration(shape: shape, gradient: backgroundGradient),
              child: child,
            );
          },
          child: _wrapWithTooltip(
...
class _RenderChipElement extends RenderObjectElement {
  ...
  @override
  void moveRenderObjectChild(RenderObject child, dynamic oldSlot,
      dynamic newSlot) {
...
class _RenderChip extends RenderBox {
  ...
  Size _layoutDeleteIcon(BoxConstraints contentConstraints,
      double contentSize) {
    final double requestedSize = math.max(0.0, contentSize);
